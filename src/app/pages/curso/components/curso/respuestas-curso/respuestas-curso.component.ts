...
@Component({
  selector: 'app-respuestas-curso',
  templateUrl: './respuestas-curso.component.html',
  styleUrls: ['./respuestas-curso.component.scss']
})
export class RespuestasCursoComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<RespuestasCursoComponent>,
